...
export const FETCH_REGISTER_CHALLENGE_REQUEST =
...
export const FETCH_REGISTER_CHALLENGE_SUCCESS =
...
export const FETCH_REGISTER_CHALLENGE_FAILURE =
...
export function fetchRegisterChallenge() {
  return function(dispatch) {
    ...
    fetch("/api/u2f/register", {
      ...
      jsonResponse(
        dispatch,
        receiveRegisterChallengeSuccess,
        receiveRegisterChallengeFailure
      ),
...
export function fetchRegisterFinish(resp) {
  return function(dispatch) {
    ...
    fetch("/api/u2f/register", {
      ...
      jsonResponse(
        dispatch,
        receiveRegisterFinishSuccess,
        receiveRegisterFinishFailure
      ),
...
export function fetchSignChallenge() {
  return function(dispatch) {
    ...
    fetch("/api/u2f/sign", {
      ...
      jsonResponse(
        dispatch,
        receiveSignChallengeSuccess,
        receiveSignChallengeFailure
      ),
...
export function fetchSignFinish(resp) {
  return function(dispatch) {
    ...
    fetch("/api/u2f/sign", {
      ...
      jsonResponse(
        dispatch,
        receiveSignFinishSuccess,
        receiveSignFinishFailure
      ),
...
export function fetchRegistrationsIfNeeded() {
  return function(dispatch, getState) {
    const { u2f } = getState();
    if (
      u2f.getIn(["registrations", "receivedAt"]) ||
      u2f.getIn(["registrations", "isFetching"])
    ) {
    ...
    fetch("/api/u2f/registrations", {
      ...
      jsonResponse(
        dispatch,
        receiveRegistrationsSuccess,
        receiveRegistrationsFailure
      ),
...
export const FETCH_DELETE_REGISTRATION_REQUEST =
  "FETCH_DELETE_REGISTRATION_REQUEST";
...
export const FETCH_DELETE_REGISTRATION_SUCCESS =
...
export const FETCH_DELETE_REGISTRATION_FAILURE =
...
export function deleteRegistration(id) {
  return function(dispatch) {
    ...
    fetch(`/api/u2f/registrations/${id}`, {
      ...
      stringResponse(
        dispatch,
        receiveDeleteRegistrationSuccess,
        receiveDeleteRegistrationFailure
      ),
