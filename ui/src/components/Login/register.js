...
class Register extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      (!this.props.register.has("error") && nextProps.register.has("error")) ||
      (!this.props.register.has("receivedAt") &&
        nextProps.register.has("receivedAt"))
    ) {
      ...
      <form>
        {register.has("receivedAt") ? (
          <div className="verificationText">
            We've sent you a verification email. Please click that link to
...
export default connect(
  ...
  dispatch => ({
    registerUser: (email, password, keys) =>
      dispatch(register(email, password, keys)),
  })
)(Register);
