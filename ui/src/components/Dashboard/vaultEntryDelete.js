    ...
    render() {
        ...
        return (
            <div className="vaultEntryDelete">
                ...
                <button className="danger filled" onClick={ this.openDialog }>Delete this entry</button>
            </div>
        );
    }
}
...
export default connect(
    ...
    dispatch => ({ deleteByTitle: (taskID, title) => dispatch(deleteByTitle(taskID, title)) }),
)(VaultEntryDelete);
